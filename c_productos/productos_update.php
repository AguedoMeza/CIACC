		 ...
		 if ($pId == $row1[0]) 
			{
								 ...
								 SET nombre = '$pNombre', descripcion_producto = '$pDescripcion', id_tipo_producto = '$pTipoProducto', consumible = '$pConsumible', id_unidad = '$pUnidad', stock_minimo = '$pMinimo'
								 WHERE
								 id_producto = $pId";
