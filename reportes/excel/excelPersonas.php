...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'REPORTE DE PERSONAS')
            ->setCellValue('A2', 'Nombre')
            ->setCellValue('B2', 'Estado Civil')
            ->setCellValue('C2', 'Correo Electrónico')
            ->setCellValue('D2', 'Telefono')
            ->setCellValue('E2', 'Fecha Registro')
...
$objPHPExcel->getActiveSheet()->getStyle('A2:F2')->applyFromArray($headerarray);    
...
INNER JOIN municipios AS m ON m.id_municipio = p.municipio WHERE p.id_sucursal = '$s_IdSucursal' AND p.activo = 1";
...
$objPHPExcel->getActiveSheet()->setTitle('Reporte de Personas');
