...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B2', 'Tipo U.')
            ->setCellValue('C2', 'Persona')
...
$s_IdSucursal = $_SESSION["s_IdSucursal"];
  ...
  $sql="SELECT u.nom_usuario, u.tipo_usuario, CONCAT(p.nombre,' ',p.ap_paterno, ' ', p.ap_materno), s.nombre
FROM
usuarios AS u
