                         ...
                         <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                             ...
                             <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                       ...
                                       <div id="cboconsumibles" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                ...
                                <!--     <div id="inputfolios" class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="display: none;">
                                        <div class="form-group">
                                            <label for="abreviatura" class="lbl">Folio:</label>
                                                <div class="error">
                                                    <input class="form-control" id="efolio" hidden placeholder="Folio del Producto" name="folio">
                                                </div>
                                       </div>
                                    </div> -->
                                     <div id="ecbounidad" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
